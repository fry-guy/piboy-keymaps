...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
	...
	--ui-buttonmap tr+dd=KEY_B+KEY_F+KEY_U:KEY_Y:750,tr+dr=KEY_E+KEY_S:KEY_Y:750,tr+du=KEY_D,tr+dl=KEY_L+KEY_R+KEY_H+KEY_T+KEY_G \
    ...
    --ui-buttonmap dd+lb=KEY_B+KEY_W+KEY_G+KEY_D,dr+lb=KEY_A+KEY_B+KEY_F,du+lb=KEY_M+KEY_S+KEY_I+KEY_T,dl+lb=KEY_R \
