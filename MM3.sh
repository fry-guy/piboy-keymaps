...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
	...
	--ui-buttonmap tr+dd=KEY_B+KEY_F+KEY_U:KEY_Y:750,tr+dr=KEY_E+KEY_S:KEY_Y:750,tr+du=KEY_D,tr+dl^click-press=KEY_L+KEY_I+KEY_H+KEY_T+KEY_G+KEY_R \
	...
	--ui-buttonmap dd+y=KEY_S+KEY_W+KEY_T+KEY_H,dr+y=KEY_D+KEY_A+KEY_F,du+y=KEY_M+KEY_I+KEY_U \
