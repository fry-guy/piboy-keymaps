...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
	...
	--ui-buttonmap a=KEY_A+KEY_F12:KEY_B+KEY_F12:1000 \
	...
	--ui-buttonmap tr+guide=KEY_I+KEY_F12,tl+guide=KEY_I+KEY_F12 \
	...
	--ui-buttonmap tr+tl=KEY_7+KEY_ENTER:KEY_RIGHTCTRL:500 \
		...
		--ui-buttonmap dd+y=KEY_S+KEY_T+KEY_W:KEY_Y+KEY_F12:750,dr+y=KEY_A+KEY_F:KEY_Y+KEY_F12:750,du+y=KEY_C+KEY_I:KEY_Y+KEY_F12:750,dl+y=KEY_M \
		--ui-buttonmap y+dd=KEY_B+KEY_T:KEY_Y+KEY_F12:750,y+dr=KEY_S:KEY_Y+KEY_F12:750,y+du=KEY_I:KEY_Y+KEY_F12:750,y+dl=KEY_F:KEY_Y+KEY_F12:750 \
		--ui-buttonmap dd+x^click-press=KEY_B+KEY_H+KEY_Y+KEY_F12,dr+x=KEY_D+KEY_S,du+x^click-press=KEY_U+KEY_N+KEY_F12 \
		--ui-buttonmap x+dd^click-press=KEY_B+KEY_H+KEY_Y+KEY_F12,x+dr=KEY_D+KEY_S,x+du^click-press=KEY_U+KEY_N+KEY_F12 \
   ...
   --ui-buttonmap rb+a^auto:0:250=cycle-key-ref:characters:forward \
	...
	--ui-buttonmap back+tl^auto:0:250=cycle-key-ref:characters:forward,back+tr^auto:0:250=cycle-key-ref:characters:backward,back+rb^auto:250:250=cycle-key-ref:list:forward,back+lb^auto:250:250=cycle-key-ref:list:backward,back+b=KEY_DOWN,back+y=KEY_UP,back+a=KEY_I:KEY_ESC:250,start+guide=KEY_I+KEY_F12 \
	 --ui-buttonmap back+start=KEY_F1+KEY_I:KEY_ESC:500 \
	--ui-buttonmap back+x=KEY_LEFTALT+KEY_F11,x+select=KEY_ESC,x+start=KEY_ENTER,x+guide=KEY_ESC+KEY_ESC:KEY_ENTER+KEY_F12:250 \
	--ui-buttonmap start+back=KEY_TAB+KEY_F12 \
	--ui-axismap x+y1=KEY_UP:KEY_DOWN:1000,x+x1=KEY_LEFT:KEY_RIGHT:1000 \
