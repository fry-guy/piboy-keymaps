...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv \
	...
	--ui-buttonmap b=KEY_F:KEY_ESC:300,x=BTN_LEFT,a=KEY_ENTER:KEY_ENTER:150,dd+a=KEY_A,du+a=KEY_B,rb=KEY_C,lb=KEY_Q:KEY_I:250,y=KEY_M:KEY_V:250,guide=KEY_LEFTCTRL,tl^click-press=KEY_SPACE,tr^click-press=KEY_SPACE \
	...
	--ui-buttonmap tr+dd=KEY_B+KEY_U+KEY_F:KEY_Y:750,tr+dr=KEY_E+KEY_S:KEY_Y:750,tr+du=KEY_D,tr+dl=KEY_L+KEY_R+KEY_H+KEY_T+KEY_G \
	...
	--ui-buttonmap dd+lb=KEY_B+KEY_W+KEY_G+KEY_D,dr+lb=KEY_A+KEY_B+KEY_F,du+lb=KEY_C+KEY_S+KEY_I+KEY_T,dl+lb=KEY_M+KEY_R \
	...
	--ui-buttonmap tl+du=cycle-key:KEY_0:KEY_1:KEY_2:KEY_3:KEY_4:KEY_5:KEY_6:KEY_7:KEY_8:KEY_9 \
