...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv \
	...
	--ui-buttonmap tr+dd=KEY_B+KEY_S+KEY_U:KEY_Y:750,tr+dr=KEY_E+KEY_F:KEY_Y:750,tr+du=KEY_D+KEY_I:KEY_Y:750,tr+dl^click-press=KEY_R+KEY_I+KEY_H+KEY_T+KEY_G \
