...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
	...
	--ui-buttonmap start=KEY_Y:KEY_ENTER:250,back=KEY_ESC:KEY_ESC:250,dd^auto:350:500=KEY_UP,du^auto:350:500=KEY_DOWN,dl^auto:350:500=KEY_LEFT,dr^auto:350:500=KEY_RIGHT \
	--ui-buttonmap dd+start=KEY_Y,du+start=KEY_ENTER,dd+back=KEY_N,du+back=KEY_ESC \
	--ui-buttonmap b=KEY_F,x=BTN_LEFT,a^click-press^auto:1000=KEY_A+KEY_ENTER,dd+a=KEY_B,du+a=KEY_R,rb=KEY_C,lb=KEY_Q:KEY_I:250,y=KEY_M:KEY_V:250,guide=KEY_LEFTCTRL,tl^click-press=KEY_SPACE,tr^click-press=KEY_F12 \
	...
	--ui-buttonmap guide+dl=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/air.macro \
       --ui-buttonmap tl+dr=KEY_B+KEY_E:KEY_U:750,tl+dl=KEY_R:KEY_D:750 \
	   ...
	   --ui-buttonmap tr+dd=KEY_S:KEY_B+KEY_Y:750,tr+du=KEY_R+KEY_I:KEY_D+KEY_Y:750 \
