...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
	...
	--ui-buttonmap b=KEY_F,x=BTN_LEFT,a=KEY_ENTER:KEY_A:150,dd+a=KEY_B,du+a=KEY_R,rb=KEY_C,lb=KEY_Q:KEY_I:250,y=KEY_M:KEY_V:250,guide=KEY_LEFTCTRL,tl^click-press=KEY_SPACE,tr^click-press=KEY_F12 \
