...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv \
	...
	--ui-buttonmap start=KEY_ENTER:KEY_Y:500,back=KEY_ESC:KEY_N:500,dd^auto:250:500=KEY_UP,du^auto:250:500=KEY_DOWN,dl=KEY_LEFT,dr=KEY_RIGHT,b=KEY_F:KEY_ESC:300,x=BTN_LEFT,a=KEY_ENTER:KEY_ENTER:150,dd+a=KEY_A,du+a=KEY_B,rb=KEY_C,lb=KEY_Q:KEY_I:250,y=KEY_M:KEY_V:250,guide=KEY_LEFTCTRL,tl=KEY_SPACE \
