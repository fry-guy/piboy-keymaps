...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv \
	...
	--ui-buttonmap tr+dd=KEY_B+KEY_U+KEY_F:KEY_Y:750,tr+dr=KEY_E+KEY_S:KEY_Y:750,tr+du=KEY_D,tr+dl^click-press=KEY_L+KEY_I+KEY_H+KEY_T+KEY_G+KEY_R \
	...
	--ui-buttonmap dd+y=KEY_S+KEY_T+KEY_H:KEY_W:300,dr+y=KEY_D+KEY_F:KEY_A:300,du+y=KEY_I+KEY_U:KEY_C:300,dl+y=KEY_M:KEY_M:300 \
