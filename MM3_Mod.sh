...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
	...
	--ui-buttonmap lb=KEY_Q:KEY_I:250 \
		--ui-buttonmap lb+dd=KEY_F,lb+dr^click-both=KEY_E,lb+du=KEY_C,lb+dl=KEY_A \
	...
	--ui-buttonmap a+dd=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/wizeye.macro \
