...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
	...
	--ui-buttonmap a=KEY_A,dd+a=KEY_B,du+a=KEY_R \
	...
	--ui-buttonmap lb+dd=KEY_F,lb+dr^click-press=KEY_E,lb+du=KEY_C,lb+dl=KEY_A \
	...
	--ui-buttonmap b+dd=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/townportal.macro \
	--ui-buttonmap b+dr=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/beacon.macro \
	--ui-buttonmap b+du=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/naturesgate.macro \
