...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
    ...
    --ui-buttonmap lb+b^auto:250:250=cycle-key-ref:list:forward \
    --ui-buttonmap lb+y^auto:250:250=cycle-key-ref:list:backward \
    --ui-buttonmap rb+y=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/clearselection.macro \
    --ui-buttonmap lb+x=KEY_PAGEUP+KEY_UP,lb+a=KEY_PAGEDOWN+KEY_DOWN \
    ...
    --ui-buttonmap a+b^auto:250:250=cycle-key-ref:characters:forward \
    --ui-buttonmap a+rb^auto:250:250=cycle-key-ref:characters:backward \
