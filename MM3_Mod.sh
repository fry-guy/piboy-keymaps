...
sudo /opt/retropie/supplementary/xboxdrv/bin/xboxdrv >> /dev/shm/runcommand.log 2>&1  \
	...
	--ui-buttonmap rb=KEY_C:KEY_F12:250 \
	...
	--ui-buttonmap b=KEY_F:KEY_F12:250 \
	...
	--ui-buttonmap b+dr=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/light.macro \
	--ui-buttonmap b+du=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/walkonwater.macro \
	--ui-buttonmap b+dl=macro:/home/pi/RetroPie/roms/ports/xboxdrv_macros/levitate.macro \
